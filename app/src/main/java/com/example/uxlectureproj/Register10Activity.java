...
public class Register10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.register10), (v, insets) -> {
        ...
        registertonext.setOnClickListener(v -> {
            Intent intent=new Intent(Register10Activity.this, Register11Activity.class);
            startActivity(intent);
        });

        registertoback=findViewById(R.id.buttonback);
        registertoback.setOnClickListener(v -> {
            Intent intent=new Intent(Register10Activity.this, Register9Activity.class);
            startActivity(intent);
        });
    }
}