...
public class Register6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.register6), (v, insets) -> {
        ...
        registertonext.setOnClickListener(v -> {
            Intent intent=new Intent(Register6Activity.this, Register7Activity.class);
            startActivity(intent);
        });

        registertoback=findViewById(R.id.buttonback);
        registertoback.setOnClickListener(v -> {
            Intent intent=new Intent(Register6Activity.this, Register5Activity.class);
            startActivity(intent);
        });
    }
}